...
<nav class="navbar-inverse">
	...
	<div class="container" style="margin-top: 20px;">
		...
		<form action="add3" id="infoForm" class="form-horizontal" method="get" >
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" name="speaker_id" id="speaker_id" placeholder="请选择讲师" type="text">
				</div>
			</div>
			<div class="form-group">
				<label for="course_id" class="col-sm-2 control-label">所属课程</label>
				<div class="col-sm-10">
					<input class="form-control" name="course_id" id="course_id" placeholder="请选择所属课程" href="">
				</div>
			</div>
			<div class="form-group">
				<label for="time" class="col-sm-2 control-label">视频时长(秒)</label>
				<div class="col-sm-10">
					<input class="form-control" name="time" id="time" placeholder="精确到秒(正整数)" type="text">
				</div>
			</div>
			<div class="form-group">
				<label for="image_url" class="col-sm-2 control-label">封面图片地址</label>
				<div class="col-sm-10">
					<input class="form-control" name="image_url" id="image_url" placeholder="具体的url" type="text">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" name="video_url" id="video_url" placeholder="具体的url" type="text">
				</div>
			</div>
			<div class="form-group">
				<label for=""detail"" class="col-sm-2 control-label">视频信息介绍</label>
				<div class="col-sm-10">
					<input class="form-control" name="detail" id=""detail"" placeholder="具体的信息内容" type="text">
				</div>
			</div>
			<div class="form-group">
