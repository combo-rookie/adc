...
<nav class="navbar-inverse">
	...
	<div class="container" style="margin-top: 20px;">
		...
		<form action="add" id="infoForm" class="form-horizontal" method="get" >
			
				<div class="form-group">
				<label for="subjectTitle" class="col-sm-2 control-label">所属学科</label>
				<div class="col-sm-10">
...
<script src="static/z/bootstrap/js/bootstrap.js"></script>
