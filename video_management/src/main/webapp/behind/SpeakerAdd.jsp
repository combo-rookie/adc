...
<nav class="navbar-inverse">
	...
	<div class="container" style="margin-top: 20px;">
		...
		<form action="add2" id="infoForm" class="form-horizontal" method="get" >
			<div class="form-group">
			    <label for="speaker_name" class="col-sm-2 control-label">姓名</label>
			    <div class="col-sm-10">

			<input class="form-control" name="speaker_name" id="speaker_name" placeholder="请输入姓名" type="text">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" name="speaker_job" id="speaker_job" placeholder="职位" type="text">
				</div>
			</div>
			<div class="form-group">
				<label for="pic_url" class="col-sm-2 control-label">头像地址</label>
				<div class="col-sm-10">
					<input class="form-control" name="pic_url" id="pic_url" placeholder="头像地址" href="">
				</div>
			</div>
			<div class="form-group">
				<label for="speaker_desc" class="col-sm-2 control-label">简介</label>
				<div class="col-sm-10">
					<input class="form-control" name="speaker_desc" id="speaker_desc" placeholder="简介" type="text">
				</div>
			</div>
			<div class="form-group">
