...
<header>
	<div class="container">
		...
		<a target="_blank" href="login.jsp"><img src="static/z/we.png" draggable="false">后台管理</a>
        ...
        <div class="container">
            ...
            <div class="course-info">
                <table cellspacing="10">
                    <tbody><tr>
                        <td colspan="2">
                            <a href="webClass?accounts=${list.accounts}" >
                        ...
                        <td>
                            <!--上线时修改id-->
                            <a href="uiClass?accounts=${list.accounts}">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <a  href="pyClass?accounts=${list.accounts}">
                    ...
                    <tr>
                        <td colspan="2">
                            <a href="phpClass?accounts=${list.accounts}">
