...
function on() {
	//alert("00000")
	$.ajax({
		url:"${pageContext.request.contextPath}/is_password",	// 指定请求URL
		type:"get",		// 指定请求方式	
		data:{			// 请求附带的参数
		...
		<div class="container clearfix">
			...
			<div id="user_bar">
				<a>
					...
					<c:if test="${empty list.imgurl}">
						<img id="avatar" src="${pageContext.request.contextPath}/static/z/avatar_lg.png" alt="" width="30px;">
					</c:if>
				</a>
                ...
                <div class="proflle_tab_body">
                    <div class="proflle_tab_workplace clearfix">
                        ...
                        <div class="profile_ifo_area">
                            <form action="${pageContext.request.contextPath}/person_update_finish?id=${list.id}" method="post" >
                                <div class="form_group">
                                    <span class="dd">旧　密　码：</span>
                                    <input  type="password" name="old_password" id="password" onblur="on()"><span id="oldMsg"></span>
                                </div>
                                <div class="form_group">
                                    <span class="dd">新　密　码：</span>
                                    <input type="password" id="regPsw" name="password" >
                                </div>
                                <div class="form_group">
                                    <span class="dd">确认新密码：</span>
                                    <input  type="password" id="regPswAgain"><span id="passMsg"></span>
                                </div>
