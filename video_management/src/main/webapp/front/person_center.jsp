	...
	<menu>
		<div class="container clearfix">
			<ul class="clearfix f_left">
				...
				<li ><a href="${pageContext.request.contextPath}/person_center">个人中心</a></li>
			</ul>
			<div id="user_bar">
				<a >
        ...
        <div class="container">
            ...
            <div id="profile_tab">
                <ul class="profile_tab_header f_left clearfix">
                    <li><a href="${pageContext.request.contextPath}/front/person_update.jsp">更改资料</a></li>
                ...
                <div class="proflle_tab_body">
                    ...
                    <div class="proflle_tab_workplace clearfix">
                        ...
                        <ul class="profile_ifo_area">
                            <li><span class="dd">昵　称：</span>${list.nickname}</li>
                            <li><span class="dd">性　别：</span>${list.sex}</li>
                            <li><span class="dd">生　日：</span>${list.birthday}</li>
                            <li><span class="dd">邮　箱：</span>${list.accounts}</li>
                            <li><span class="dd">所在地：</span>${list.address}</li>
                        </ul>
                    </div>
                </div>
            </div>
