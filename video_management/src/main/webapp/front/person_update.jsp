...
<header>
	...
	<menu>
		<div class="container clearfix">
			...
			<li class="menu_active"><a href="${pageContext.request.contextPath}/person_center">个人中心</a></li>
			</ul>
			<div id="user_bar">
				<a> 
					<c:if test="${!empty list.imgurl}">
						<img id="avatar" src="${list.imgurl}" alt="" width="30px;">
					</c:if> <c:if test="${empty list.imgurl}">
						<img id="avatar" src="${pageContext.request.contextPath}/static/z/avatar_lg.png" width="30px;">
					</c:if>
				</a> 
        ...
        <div class="container">
            ...
            <div id="profile_tab">
                <ul class="profile_tab_header f_left clearfix">
                     <li><a href="person_update.jsp">更改资料</a></li>
                    <li class="profile_tab_line">|</li>
                    <li><a href="${pageContext.request.contextPath}/front/person_img.jsp">更改头像</a></li>
                    <li class="profile_tab_line">|</li>
                    <li><a href="${pageContext.request.contextPath}/front/person_password.jsp">密码安全</a></li>
                </ul>
                <div class="proflle_tab_body">
                    <div class="proflle_tab_workplace clearfix">
                        <div class="profile_avatar_area">
                                ...
                                <c:if test="${!empty list.imgurl}">
								<img id="avatar" width="200px;" src="${list.imgurl}" >
							</c:if>
					
							<c:if test="${empty list.imgurl}">
								<img id="avatar" src="${pageContext.request.contextPath}/static/z/avatar_lg.png" width="200px;" >
							</c:if>
                        </div>
                        <div class="profile_ifo_area">
                            <form action="person_update_finish">
                                <input name="id" value="${list.id}" type="hidden">
                                <div class="form_group">
                                    <span class="dd">昵　称：</span><input name="nickname" type="text" value="${list.nickname}">
                                
                                </div>
                                <div class="form_group">
                                    <span class="dd">性　别：</span>
                                   
                                    <input id="man"  type="radio" name="sex" value="男" <c:if test="${list.sex=='男'}">checked</c:if>>
                                    <label for="man">男</label>
                                    <input id="woman"  type="radio" name="sex" value="女" <c:if test="${list.sex=='女'}">checked</c:if>>
                                    <label for="woman">女</label>     
                                </div>
                                <div class="form_group">
                                    <span class="dd">生　日：</span>  <!-- 1990-10-04 -->
                                    <input name="birthday" type="text" value="${list.birthday}">
                                </div>
                                <div class="form_group">
                                    <span class="dd" >邮　箱：</span>
                                   <input name="accounts" type="text" value="${list.accounts}" readonly="readonly">
                                </div>
                               <div class="form_group">
